...
extern void conoutfv(int type, const char *fmt, va_list args); // gear4 - messages (graphox) - 08/05/2012
...
extern void aliasa(const char *name, char *action); // gear4 07/05/2012
extern void pushident(ident &id, char *val); // gear4 07/05/2012
extern int sortbythat; //a_teammate 26.02.2011
extern int kmode; //a_teammate 26.02.2011
extern int kmaster; //a_teammate 26.02.2011
extern int gameStarted; // gear4 07/05/2012
extern int _Graphox_crosshairbump; // gear4 07/05/2012
extern int _Graphox_bumpcrossonkill; // gear4 07/05/2012
extern int _Graphox_bumpcrossonpickup; // gear4 07/05/2012
