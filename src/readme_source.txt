GraphOX Sauerbraten source code license, usage, and documentation.

You may use the GraphOX Sauerbraten source code if you abide by the ZLIB license
...
GraphOX Sauerbraten game engine source code, any release.

Copyright (C) 2001-2010 Wouter van Oortmerssen, Lee Salzman, Mike Dysart, Robert Pointon, Quinton Reeves, Bram Wall, Malte Haase and Aaron Marais
